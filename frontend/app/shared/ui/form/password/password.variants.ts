...
export const passwordVariants = tv({
  base:
    "flex justify-center items-center w-full gap-4 text-white placeholder:text-input-placeholder px-5 py-5.5 bg-transparent rounded-2xl border-2 border-input-outline transition duration-300" +
