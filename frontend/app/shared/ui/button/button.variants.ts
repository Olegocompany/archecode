...
export const buttonVariants = tv({
  base:
    ...
    " disabled:bg-none disabled:bg-gray disabled:border-light-gray disabled:text-white/50 disabled:[box-shadow:0_0_12px_rgba(48,48,48,1.0)] disabled:active:opacity-100" +
    " leading-none",
  ...
  variants: {
    type: {
      accent: "",
      danger:
        "[box-shadow:0_0_12px_rgba(218,43,43,0.5)] hover:[box-shadow:0_0_12px_rgba(218,43,43,0.5)]" +
      ...
      solid:
        "[box-shadow:0_0_12px_rgba(48,48,48,0.5)] hover:[box-shadow:0_0_12px_rgba(48,48,48,0.5)]" +
